...
- **Not for commercial use** — provided as-is for individual learners.

If any content here is inaccurate or outdated, consult the primary sources below.
...
The entire guide is contained in [`index.html`](./index.html) — a static page with no build step or external dependencies (aside from a Google Fonts stylesheet).

## Usage

Open `index.html` in any browser to browse grammar topics by CEFR level.

## License / Disclaimer

Provided for personal, non-commercial, educational use. No warranty is made as to the completeness or accuracy of the content.
